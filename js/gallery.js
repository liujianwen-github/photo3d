		...
		if(camera.tx) {
			...
			if(!m) {
				...
				if(selected.url) {
					...
					urlInfo.style.width = '300px'

					urlInfo.style.top = Math.round(selected.img.offsetTop + selected.img.offsetHeight - urlInfo.offsetHeight) + "px";

					urlInfo.style.left = Math.round(selected.img.offsetLeft + selected.img.offsetWidth - urlInfo.offsetWidth-1) + "px";
